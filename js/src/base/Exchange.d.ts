...
export default class Exchange {
    ...
    milliseconds: () => number;
    binaryToBase16: any;
    numberToBE: (n: number, padding: number) => any;
    base16ToBinary: any;
    ...
    binaryConcat: any;
    hash: (request: string | Uint8Array<ArrayBufferLike>, hash: secp256k1, digest?: "binary" | "hex" | "base64") => any;
    arrayConcat: (a: any[], b: any[]) => any[];
    encode: any;
    urlencode: (object: object, sort?: boolean) => string;
    hmac: (request: string | Uint8Array<ArrayBufferLike>, secret: string | Uint8Array<ArrayBufferLike>, hash: secp256k1, digest?: "binary" | "hex" | "base64") => any;
    ...
    stringToBase64: (string: string) => any;
    decode: any;
    uuid22: (a?: any) => string;
    ...
    base64ToString: (string: string) => any;
    crc32: typeof functions.crc32;
    packb: typeof functions.packb;
    urlencodeBase64: (payload: string | Uint8Array) => any;
    ...
    stringToBinary(content: any): any;
    binaryToString(binary: any): any;
    ...
    ethAbiEncode(types: any, args: any): any;
    ethEncodeStructuredData(domain: any, messageTypes: any, messageData: any): any;
    ...
    createCcxtTradeId(timestamp?: Int, side?: OrderSide, amount?: any, price?: any, takerOrMaker?: any): any;
